...
// List how many times booked by customer

// 5. List how many times a customer has booked the room
router.get("/customerbookings/:customerName", (req, res) => {
  const { customerName } = req.params;

  const customerBookings = bookingDetails.filter(
...
router.get('/', function (req, res, next) {
  ...
  <h3>GET: /customerbookings/:customerNamer</h3>
  `);
});
